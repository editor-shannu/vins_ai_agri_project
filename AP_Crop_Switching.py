...
print()
print("CONCLUSION:")
print(f"  Farmers in {most_volatile} show highest switching behaviour.")
print(f"  {most_stable} is the most stable district.")
print(f"  {most_switched} is abandoned most frequently.")
print(f"  {top_feature} is the strongest predictor of switching.")
print(f"  {best_model_row['Model']} achieved best cross-validated accuracy of {best_model_row['CV Accuracy (5-fold)']}.")
